...
DO $$
BEGIN
    IF NOT EXISTS (SELECT FROM pg_roles WHERE rolname = 'vulnshop_user') THEN
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO vulnshop_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO vulnshop_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON TABLES TO vulnshop_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON SEQUENCES TO vulnshop_user;
